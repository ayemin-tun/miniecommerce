        ...
        <div class="d-flex align-items-center">
            ...
            @if (LaravelLocalization::getCurrentLocale() == 'en')
                <small class="nav-item">
                    <a href="{{ LaravelLocalization::getLocalizedURL('my') }}" data-mdb-toggle="tooltip"
                        title="@lang('nav.change_lan')" class="nav-link text-white m-2" data-mdb-placement="left">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Flag_of_Myanmar.svg/2560px-Flag_of_Myanmar.svg.png"
                            class="img-fluid rounded" alt="" srcset="" width="20px" height="20px">
                    </a>
                </small>
            @endif
            ...
            @if (LaravelLocalization::getCurrentLocale() == 'my')
                <small class="nav-item">
                    <a href="{{ LaravelLocalization::getLocalizedURL('en') }}" data-mdb-toggle="tooltip"
                        title="@lang('nav.change_lan')" class="nav-link text-white m-2" data-mdb-placement="left">
                    ...
                    <ul class="navbar-nav me-auto mb02 mb-lg-0" style="float:left;">
                        ...
                        <li class="nav-item pt-2">
                            <a href="#" data-mdb-toggle="tooltip" title="{{ Auth::user()->role }}"
                                class="text-light" data-mdb-placement="bottom">
